  ...
  en: {
    translation: {
      ...
      services: {
        ...
        title_span: "Services",
        cards: [
          { id: 'brand', title: 'Brand Identity', desc: 'Crafting cohesive brand experiences that resonate with your audience.' },
          { id: 'web', title: 'Website Dev', desc: 'Fast, responsive, and scalable web applications.' },
          { id: 'uiux', title: 'UI/UX Design', desc: 'Intuitive interfaces that enhance user satisfaction.' },
          { id: 'app', title: 'App Development', desc: 'Custom mobile applications for iOS and Android.' },
          { id: 'logo', title: 'Logo Design', desc: 'Memorable and timeless logos that define your core identity.' },
          { id: 'social', title: 'Social Media', desc: 'Strategic management to grow your online community.' },
          { id: 'content', title: 'Content Creation', desc: 'Engaging content tailored for multiple digital platforms.' },
          { id: 'ads', title: 'Advertising', desc: 'Targeted campaigns that maximize your ROI and reach.' },
          { id: 'photo', title: 'Photography', desc: 'High-quality visual assets for your brand.' },
          { id: 'video', title: 'Video Production', desc: 'Compelling storytelling through professional video.' },
          { id: 'motion', title: 'Motion Graphics', desc: 'Dynamic animations to bring your ideas to life.' },
          { id: 'printing', title: 'Printing', desc: 'Premium quality print materials for offline impact.' },
          { id: 'digital', title: 'Digital Marketing', desc: 'Comprehensive strategies to boost your digital presence.' },
        ]
      },
      portfolio: {
  ...
  ar: {
    translation: {
      ...
      services: {
        ...
        title_span: "شاملة",
        cards: [
          { id: 'brand', title: 'هوية العلامة التجارية', desc: 'صياغة تجارب متماسكة للعلامة التجارية يتردد صداها مع جمهورك.' },
          { id: 'logo', title: 'تصميم الشعار', desc: 'شعارات لا تُنسى وخالدة تحدد هويتك الأساسية.' },
          { id: 'social', title: 'وسائل التواصل الاجتماعي', desc: 'إدارة استراتيجية لتنمية مجتمعك عبر الإنترنت.' },
          { id: 'content', title: 'صناعة المحتوى', desc: 'محتوى جذاب مخصص لمنصات رقمية متعددة.' },
          { id: 'ads', title: 'الإعلانات', desc: 'حملات مستهدفة تزيد من عائد الاستثمار والوصول.' },
          { id: 'web', title: 'تطوير المواقع', desc: 'تطبيقات ويب سريعة وسريعة الاستجابة وقابلة للتطوير.' },
          { id: 'uiux', title: 'تصميم واجهة المستخدم', desc: 'واجهات بديهية تعزز رضا المستخدم.' },
          { id: 'app', title: 'تطوير التطبيقات', desc: 'تطبيقات جوال مخصصة لنظامي iOS وأندرويد.' },
          { id: 'photo', title: 'التصوير', desc: 'أصول مرئية عالية الجودة لعلامتك التجارية.' },
          { id: 'video', title: 'إنتاج الفيديو', desc: 'سرد قصصي مقنع من خلال فيديو احترافي.' },
          { id: 'motion', title: 'الموشن جرافيك', desc: 'رسوم متحركة ديناميكية لإحياء أفكارك.' },
          { id: 'printing', title: 'الطباعة', desc: 'مواد مطبوعة عالية الجودة للتأثير خارج الإنترنت.' },
          { id: 'digital', title: 'التسويق الرقمي', desc: 'استراتيجيات شاملة لتعزيز حضورك الرقمي.' },
        ]
      },
      portfolio: {
